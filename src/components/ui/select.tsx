...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
     ...
     "text-stone-950 dark:text-stone-50", className
    )}
    {...props}
  >
